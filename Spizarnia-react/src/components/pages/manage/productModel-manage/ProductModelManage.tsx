  ...
  return (
    <div className="manage-content">
      ...
      <form
        ...
        className="form-product-model-container"
      >
        <input
        ...
        />
        {errors.unit && (
          <span className="error-message">{errors.unit.message}</span>
        )}
        ...
        <input
          className="form-product-model-input"
          type="number"
          step="0.01" // Pozwala na wartości dziesiętne
          {...register("price", {
            ...
            validate: (value) => {
              ...
              return !isNaN(parsedValue) ? true : "Cena musi być liczbą";
            },
          })}
          placeholder="Cena"
          onChange={(e) => {
            e.target.value = e.target.value.replace(",", "."); // Zamiana przecinka na kropkę
          }}
        />
        {errors.price && (
